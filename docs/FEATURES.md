...
| Mobile photo gestures | Day Photos opens that day’s grid; sideways drag, pinch/double-tap zoom, bounded pan, pull-up location map and next-day handoff. Controls stay visible; Back/Close return to the day map | Same day/photo data and private-photo loader; immediate, interruptible swipes; reduced motion and album boundaries respected | mobile-ux.js, mobile.css |
