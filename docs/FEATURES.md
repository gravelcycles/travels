...
| Route overview and focus | Whole-trip/day bounds, quiet context, day bubbles clear transit strokes with leaders reaching mapped arrival points; tiny orange rail-stop dots sit inside the rail line; route inspection and named stops | Places, ordered `segmentIds`, segments/geometry; map actions disable when no coordinates exist | app.js |
