...
| Mobile and direct entry | Days/Map/Journal views, day/photo deep links, keyboard/focus behavior, reduced-motion support | Same markup/styles/scripts for all journeys | journey.html, app.js, styles.css |
