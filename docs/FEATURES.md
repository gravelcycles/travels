...
| Route overview and focus | Whole-trip/day bounds, quiet context, route inspection and named stops; small orange intermediate rail stops with white rims spanning the line, larger dots at both ends of every train leg. Day selection stays in the journal/navigation; no map day-number bubbles or connectors | Places, ordered `segmentIds`, segments/geometry; map actions disable when no coordinates exist | app.js |
...
| Mobile Replay | Separate Map/Photos views, anchored timeline and playback controls, compact day story and Explore day action; landscape uses a media/story split | Shared automatic/curated moments; photo view disables when a moment has no photo | journey.html, app.js, mobile-ux.js, mobile.css |
