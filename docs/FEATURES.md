...
| Mobile day experience | Map-led day screen with compact summary, Day details/photos and bottom day navigation; day picker contains journey-wide actions, details contain the route key; no top menu or duplicate All days link | Same shared template with mobile styles; empty routes/photos have explicit states | journey.html, app.js, mobile-ux.js, mobile.css |
