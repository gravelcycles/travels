...
| Route overview and focus | Whole-trip/day bounds, quiet context, day markers, route inspection, named stops | Places, ordered `segmentIds`, segments/geometry; map actions disable when no coordinates exist | app.js |
