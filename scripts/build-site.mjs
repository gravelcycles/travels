...
export function buildSite(root) {
  ...
  for (const file of ["assets/app.js", "assets/catalog.js", "assets/replay-utils.js", "assets/styles.css"]) versions.set(file, hash(fs.readFileSync(path.join(root, "dist", file))));
