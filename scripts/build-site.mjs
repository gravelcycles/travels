...
export function buildSite(root) {
  ...
  for (const file of ["assets/photo-auth.js", "assets/atlas-utils.js", "assets/group-travel.js", "assets/media-utils.js", "assets/group-travel.css", "assets/app.js", "assets/location-labels.js", "assets/catalog.js", "assets/replay-utils.js", "assets/styles.css", "assets/mobile.css", "assets/mobile-ux.js", "assets/input-mode.js"]) versions.set(file, hash(fs.readFileSync(path.join(root, "dist", file))));
